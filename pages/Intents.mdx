...
6. **Contexts:** Select the [contexts](/Contexts) the intent can act upon. Please note available [contexts](/Contexts) are created separately. Applications can choose which specific [contexts](/Contexts) they will support, from the one's provided with the intent.
