...
### Google Federation
Users can now sign in using their existing Google identities.  
This applies to both the [Connectifi Platform](https://platform.connectifi.app) site as well as authentication for apps requiring sign-in to Connectifi.  
